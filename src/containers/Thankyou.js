...
export default class Thankyou extends Component {
  render() {
    return (
      <div className="w-1/2 mx-auto bg-white shadow p-8 flex flex-col items-center rounded-lg my-8 xs:w-4/5">
        ...
        <span className="block font-normal leading-relaxed text-blue-gray-secondary px-10 py-5 text-justify xs:px-3">
        ...
        <div className="flex flex-col w-full px-10 xs:px-0">
          <button
